...
App.onJoinPlayer.Add(function(player){
    ...
    //5초간 장소 라벨 띄움
    player.showCenterLabel("사랑의 구슬 방",0xFFFFFF, 0x000000, 0, 5000);
    ...
    //채팅창에 장소 정보 게시
    App.sayToAll("[사랑의 구슬 방]", 0x9BF542);
    App.sayToAll("이곳은 사랑의 구슬 방이다.", 0x9BF542);
    App.sayToAll("목자들에게 천사가 찾아온 장면이 담겨있다.", 0x9BF542);
